# Code injection detection: gcc-Linux-Implementation
...
Packages needed (using spaces to separate them): python3 gcc openjdk-8-jdk libjna-java libssl-dev libcapstone3 libcapstone-dev python-capstone
