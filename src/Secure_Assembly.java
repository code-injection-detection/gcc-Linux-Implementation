	...
	public static void main(String[] args) throws Exception
	{
		...
		{	
			...
			while(sc.hasNext())
			{
				...
				{
					if (address_of_code_that_denotes_next_unsplit_block_change!=7) //that is because it thinks that the first verification code is a block on its own, as all the counters are still 0
					{
