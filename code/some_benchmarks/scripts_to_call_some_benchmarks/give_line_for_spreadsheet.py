...
name_of_file="./calc_determinant_sec_calc_det_11_squeezed_keys_with_padded_nops_maced_data_blocks_same_size_as_code_blocks_and_multiple_of_16/aggregated_results.txt"
...
fixed_size_sizes=[25,41,57,73] #for code block =data block
