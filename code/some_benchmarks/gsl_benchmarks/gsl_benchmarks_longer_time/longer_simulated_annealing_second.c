...
/*
gcc simulated_annealing_second.c -lgsl -lgslcblas -lm
*/


#define PRINT_RES 0

//#include <config.h> //uhh that is not needed
#include <math.h> 
#include <string.h>
#include <stdio.h>
...
/*   exhaustive_search(); */
  ...
  #else
  gsl_siman_solve(r, x_initial, Etsp, Stsp, Mtsp, NULL, NULL, NULL, NULL,
                  N_CITIES*sizeof(int), params);
  #endif
