...
/*
gcc longer_linear_least_squares_third.c  -lgsl -lgslcblas -lm
*/

#define NUM_OF_POINTS 3500000
#define PRINT_RES 0
...
main()
{
  ...
  {
    const size_t npoints = 20000;                   /* number of points on L-curve and GCV curve */
