...
/*
gcc linear_least_squares_fourth.c -lgsl -lgslcblas -lm
*/

#define NUM_OF_POINTS 250000 //orig:200
#define PRINT_RES 0
...
main()
{
  ...
  const size_t p = 80;  /* number of model parameters */
  size_t i;
  ...
  {
    const size_t npoints = NUM_OF_POINTS;                   /* number of points on L-curve and GCV curve */
