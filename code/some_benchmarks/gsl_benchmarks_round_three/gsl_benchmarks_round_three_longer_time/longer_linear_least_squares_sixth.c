...
#define NUM_OF_POINTS 360000 //orig:50000
#define PRINT_RES 0
...
int
solve_system(const int print_data1, const gsl_multilarge_linear_type * T,
             const double lambda, const size_t n, const size_t p,
             gsl_vector * c)
{
  const size_t nblock = 10;         /* number of blocks to accumulate */
...
{
  const size_t n = NUM_OF_POINTS;   /* number of observations */
